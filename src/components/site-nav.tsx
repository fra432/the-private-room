	...
	return (
		<header className="absolute inset-x-0 top-0 z-30">
			<div className="mx-auto grid max-w-6xl grid-cols-[minmax(0,1fr)_auto] items-center gap-4 px-6 py-6 md:px-10 md:py-8">
				<Link
					to="/dashboard"
					className={`min-w-0 ${logoTone} transition hover:opacity-80`}
				>
			...
			{open && (
				<div className="md:hidden">
					<div className="mx-4 border border-foreground/20 bg-white/50 px-6 py-6 backdrop-blur">
						<nav className="flex flex-col gap-4">
							...
							<button
								...
								className="text-left text-[0.85rem] tracking-[0.35em] uppercase text-foreground/70 hover:text-foreground"
							>
								Esci
							</button>
						</nav>
